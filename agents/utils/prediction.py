...
# --------------------------------------------------
# Main Prediction Function (AGENT)
# --------------------------------------------------
def predict_crypto(coin_name, start_date_str, end_date_str, forecast_days=7):
    ...
    # FIX 2: Normalize index (remove time)
    df.index = pd.to_datetime(df.index).normalize()

    # FIX 3: Force Close to be 1-D numeric array
    ...
    return {
        ...
        "symbol": symbol,
        "coin_name": coin_name,
        "feedback": "Agent-generated forecast using LSTM model.",
        "color": "green",
    }
